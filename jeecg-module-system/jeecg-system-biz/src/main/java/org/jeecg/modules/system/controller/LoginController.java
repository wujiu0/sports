...
public class LoginController {
	...
	public Result<JSONObject> login(@RequestBody SysLoginModel sysLoginModel){
		...
		if (!syspassword.equals(userpassword)) {
			...
			if (loginTemp==3){
				loginTemp = 0;
				return result.error500("连续输错三次,锁定");
	...
	private  int loginTemp = 0;
	private void  countLoginTemp(){
		loginTemp++;
	}
	 ...
	 */
	@AutoLog("进入供保数据库管理")
	@ApiOperation("进入供保数据库管理")
	@GetMapping("/gongbaologin")
	public Result<String>  gongBaoLogin(){
		return Result.OK("进入供保数据库管理");

	}
	@AutoLog("进入供应链数字孪生画像")
	@ApiOperation("进入供应链数字孪生画像")
	@GetMapping("/huaxiangLogin")
	public Result<String>  huaxiangLogin(){
		return Result.OK("进入供应链数字孪生画像");

	}

	@AutoLog("进入供应链数字孪生评价")
	@ApiOperation("进入供应链数字孪生评价")
	@GetMapping("/pingjiaLogin")
	public Result<String>  pingjiaLogin(){
		return Result.OK("进入供应链数字孪生评价");
	}

	@AutoLog("进入智能计划")
	@ApiOperation("进入智能计划")
	@GetMapping("/zhinengjihuaLogin")
	public Result<String>  zhinengjihuaLogin(){
		return Result.OK("进入智能计划");

	}
	@AutoLog("进入智能调度")
	@ApiOperation("进入智能调度")
	@GetMapping("/diaoduLogin")
	public Result<String>  diaoduLogin(){
		return Result.OK("进入智能调度");

	}
	@AutoLog("进入装箱实时监控")
	@ApiOperation("进入装箱实时监控")
	@GetMapping("/jiankongLogin")
	public Result<String>  jiankongLogin(){
		return Result.OK("进入装箱实时监控");

	}
	@AutoLog("进入装箱计划仿真")
	@ApiOperation("进入装箱计划仿真")
	@GetMapping("/fangzhenLogin")
	public Result<String>  fangzhenLogin(){
		return Result.OK("进入装箱计划仿真");
	}
